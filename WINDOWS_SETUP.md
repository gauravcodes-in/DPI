...
3. Navigate to the `DPI` project folder and click "Select Folder"
...
```bash
# If your project is at C:\Users\YourName\Downloads\DPI
cd /mnt/c/Users/YourName/Downloads/DPI
```
...
1. **File → Open Folder**
2. Select the `DPI` project folder
...
**Fix:**
Make sure you're in the `DPI` project folder:
```cmd
cd C:\full\path\to\DPI
dir include
```
